...
%Nombreuses technologies, langages, sytemes
%Logiciels complexes composés de plusieurs modèles hétérogenes
%Besoin de communiquer ensemble
    %Un systeme se définit à partir d'un automate
...
%Integrer image : automate camera + automate moniteur + bdd
