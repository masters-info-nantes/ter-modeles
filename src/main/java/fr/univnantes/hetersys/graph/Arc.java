...
public class Arc extends Element {
	 ...
	 * 
	 * @param id the id of the new {@code Arc}. @see fr.univnantes.hetersys.graph.Element#Element(int).
	 * @param name the name of the new {@code Arc}.
	 * @param next the @see fr.univnantes.hetersys.graph.Node this {@code Arc} may target.
	 */
